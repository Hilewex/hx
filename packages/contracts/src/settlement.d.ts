export type SettlementSourceType = 'ORDER' | 'ORDER_LINE' | 'REFUND' | 'CANCEL_RETURN' | 'FINANCE_CORRECTION' | 'RISK' | 'MANUAL_FOUNDATION';
export type SettlementPartyType = 'PLATFORM' | 'CREATOR' | 'SUPPLIER' | 'UNKNOWN';
