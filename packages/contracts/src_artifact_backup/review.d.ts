export type ReviewStatus = 'SUBMITTED' | 'UNDER_REVIEW' | 'APPROVED' | 'REJECTED' | 'WITHDRAWN' | 'HIDDEN' | 'ARCHIVED';
export type ReviewModerationStatus = 'PENDING' | 'APPROVED' | 'REJECTED';
export type ReviewVisibilityState = 'NOT_VISIBLE' | 'VISIBLE' | 'HIDDEN_BY_MODERATION' | 'WITHDRAWN_BY_USER' | 'ARCHIVED';
export type ReviewTrustState = 'VERIFIED_PURCHASE' | 'TRUST_IMPACT_PENDING' | 'TRUST_REDUCED_AFTER_RETURN' | 'UNVERIFIED';
export type ReviewEligibilityState = 'REQUIRES_CHECK' | 'ELIGIBLE' | 'NOT_ELIGIBLE' | 'UNKNOWN';
