...
export type SearchIntentType = 'PRODUCT' | 'CATEGORY' | 'STOREFRONT' | 'DISCOVERY' | 'AMBIGUOUS' | 'UNKNOWN';
export type SearchCandidateType = 'PRODUCT' | 'CATEGORY' | 'STOREFRONT';
export type SearchSurface = 'HOME' | 'HEADER' | 'DISCOVER' | 'CATEGORY_PLP' | 'STOREFRONT' | 'MOBILE_OVERLAY';
...
export type SearchCandidate = ProductSearchCandidate | CategorySearchCandidate | StorefrontSearchCandidate;
export type SearchEmptyStateCode = 'QUERY_REQUIRED' | 'NO_RESULTS' | 'MODE_NOT_SUPPORTED_FOUNDATION';
export interface SearchEmptyState {
    code: SearchEmptyStateCode;
    message: string;
    suggestedSurface?: SearchSurface;
}
export type SearchSuggestionType = 'QUERY_COMPLETION' | 'CATEGORY' | 'STOREFRONT' | 'TRENDING';
