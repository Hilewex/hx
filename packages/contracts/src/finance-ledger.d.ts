...
export type LedgerEntryType = 'PAYMENT_CAPTURE' | 'PLATFORM_COMMISSION' | 'SUPPLIER_PAYABLE' | 'CREATOR_SHARE' | 'COUPON_DISCOUNT' | 'REFUND' | 'REFUND_REVERSAL' | 'CORRECTION' | 'PAYOUT' | 'PAYOUT_REVERSAL';
export type LedgerSourceType = 'PAYMENT' | 'ORDER' | 'ORDER_LINE' | 'REFUND' | 'SETTLEMENT' | 'PAYOUT' | 'COUPON' | 'CAMPAIGN' | 'REWARD' | 'MANUAL_CORRECTION';
...
export type RefundFinancialImpactLimitationFlag = 'PARTIAL_REFUND_SUPPORTED_AMOUNT_BASED' | 'SETTLEMENT_ADJUSTMENT_NOT_PERFORMED' | 'PAYOUT_REVERSAL_NOT_PERFORMED' | 'PROVIDER_REFUND_EXECUTION_NOT_PERFORMED';
