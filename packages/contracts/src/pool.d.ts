import type { CreatorPriceSelectionResult, CreatorVisiblePoolBasePriceSnapshot, PoolBasePriceSnapshot, PriceCorridor, SupplierBasePriceSnapshot } from "./pricing";
export declare enum ProductAcceptanceStatus {
    DRAFT = "DRAFT",
    SUBMITTED = "SUBMITTED",
...
export type UpdateSupplierProductDraftCommand = {
    actor: PoolActorContext;
    id: string;
} & Partial<Pick<SupplierSubmittedProduct, "title" | "description" | "brand" | "categoryId" | "tags" | "variants" | "logistics">>;
...
export type PoolActorType = "SUPPLIER" | "ADMIN" | "OPERATOR" | "SYSTEM" | "CREATOR";
...
export type PoolResult<T> = {
    ...
    success: false;
    error: PoolErrorResult;
};
export declare enum CommercialPoolStatus {
    PENDING = "PENDING",
    ACTIVE = "ACTIVE",
    SUSPENDED = "SUSPENDED",
    ARCHIVED = "ARCHIVED"
}
export declare enum PoolBindingStatus {
    PENDING = "PENDING",
    BOUND = "BOUND",
    FAILED = "FAILED"
}
export declare enum PoolBindingType {
    PRICING = "PRICING",
    STOCK = "STOCK",
    CATEGORY = "CATEGORY",
    MEDIA = "MEDIA"
...
export interface CommercializationSnapshot {
    ...
    data: Pick<SupplierSubmittedProduct, "title" | "description" | "brand" | "categoryId" | "tags" | "variants" | "logistics">;
}
...
export interface CreatorVisibleCommercialPoolProduct extends Omit<CommercialPoolProduct, "supplierBasePriceSnapshot" | "poolBasePriceSnapshot"> {
...
export declare enum CreatorStoreProductStatus {
    ACTIVE = "ACTIVE",
    PAUSED = "PAUSED",
    REMOVED = "REMOVED"
}
export declare enum CreatorStoreProductVisibility {
    VISIBLE = "VISIBLE",
    HIDDEN = "HIDDEN"
}
export declare enum CreatorStoreProductMediaType {
    IMAGE = "IMAGE",
    VIDEO = "VIDEO"
}
export declare enum CreatorStoreProductMediaUsage {
