...
export type PayoutStatus = 'REQUESTED' | 'APPROVED' | 'PROCESSING' | 'SUCCEEDED' | 'FAILED' | 'CANCELLED' | 'UNKNOWN_RESULT';
export type PayoutSourceType = 'SETTLEMENT' | 'SETTLEMENT_LINE' | 'PAYABLE' | 'MANUAL_ADJUSTMENT';
...
export type PayoutBoundaryLimitationFlag = 'PROVIDER_PAYOUT_EXECUTION_NOT_PERFORMED' | 'PAYABLE_LIFECYCLE_FOUNDATION_ONLY' | 'SETTLEMENT_TRUTH_NOT_MUTATED' | 'LEDGER_TRUTH_NOT_MUTATED' | 'APPROVAL_WORKFLOW_NOT_IMPLEMENTED' | 'AUDIT_WORKFLOW_NOT_ENFORCED' | 'DUPLICATE_IDEMPOTENCY_KEY_CONFLICT' | 'DUPLICATE_PAYOUT_SOURCE_CONFLICT';
