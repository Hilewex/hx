export type InteractionActorType = 'CUSTOMER' | 'CREATOR' | 'ADMIN' | 'SYSTEM';
export type InteractionTargetType = 'POST' | 'STORY' | 'VIDEO' | 'QUESTION' | 'ANSWER' | 'MEDIA' | 'PRODUCT' | 'STORE_POST' | 'USER_PRODUCT_STORY' | 'STORE_STORY' | 'VIDEO_PRODUCT_CARD' | 'REVIEW' | 'QA_QUESTION' | 'QA_ANSWER';
export type InteractionActionType = 'LIKE' | 'SAVE' | 'SHARE' | 'HELPFUL' | 'VOTE_UP' | 'VOTE_DOWN';
export type InteractionState = 'ACTIVE' | 'REMOVED';
export type InteractionVisibility = 'PRIVATE' | 'PUBLIC_AGGREGATE_ONLY';
export type InteractionTargetVisibility = 'PUBLIC' | 'NOT_VISIBLE' | 'PENDING' | 'REJECTED' | 'HIDDEN' | 'REMOVED';
