export type RefundState = 'CREATED' | 'VALIDATED' | 'PROCESSING' | 'SUCCEEDED' | 'FAILED' | 'CANCELLED' | 'UNKNOWN_RESULT' | 'RECONCILIATION_REQUIRED' | 'CLOSED';
export type RefundSourceType = 'CANCEL' | 'RETURN';
export type RefundReasonType = 'CUSTOMER_CANCEL' | 'RETURN_APPROVED' | 'OPERATIONAL_ADJUSTMENT' | 'MANUAL_REVIEW';
export type RefundCouponSponsorReversalStatus = 'CALCULATED' | 'BLOCKED' | 'CONFLICT';
