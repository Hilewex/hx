...
export type AnalyticsIngestionSource = 'API' | 'EVENT_OUTBOX' | 'AUDIT_LOG' | 'BFF_CONTEXT' | 'ADMIN_PANEL' | 'SYSTEM' | 'SYSTEM_SMOKE' | 'FOUNDATION_SIMULATION';
export type AnalyticsActorType = 'ANONYMOUS' | 'CUSTOMER' | 'CREATOR' | 'ADMIN' | 'OPERATOR' | 'SYSTEM' | 'INTERNAL_SERVICE';
