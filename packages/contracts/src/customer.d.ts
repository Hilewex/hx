export declare enum CustomerAccountStatus {
    ACTIVE = "ACTIVE",
    SUSPENDED = "SUSPENDED",
    CLOSED = "CLOSED"
}
export declare enum CustomerProfileVisibility {
    PRIVATE = "PRIVATE",
    LIMITED = "LIMITED"
}
export declare enum CustomerAccountType {
...
export type SuspendCustomerProfileResult = {
    version: number;
};
export type ReactivateCustomerProfileResult = {
    version: number;
};
export type CloseCustomerProfileResult = {
    version: number;
};
export declare enum CustomerCapability {
