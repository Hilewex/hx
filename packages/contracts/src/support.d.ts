...
export type SupportActionType = 'VIEW_ORDER_SUPPORT_CONTEXT' | 'VIEW_CUSTOMER_SUPPORT_CONTEXT' | 'CREATE_SUPPORT_TRIAGE_HANDOFF' | 'REQUEST_ORDER_OWNER_REVIEW' | 'REQUEST_REFUND_OWNER_REVIEW' | 'REQUEST_ESCALATION_REVIEW' | 'ASSIGN_SUPPORT_TICKET_FOUNDATION';
export type SupportActionTargetType = 'ORDER' | 'CUSTOMER' | 'SUPPORT_TICKET' | 'REFUND' | 'ESCALATION' | 'TRIAGE_HANDOFF';
export type SupportPermissionCode = 'CAN_VIEW_ORDER_SUPPORT_CONTEXT' | 'CAN_VIEW_CUSTOMER_SUPPORT_CONTEXT' | 'CAN_CREATE_SUPPORT_TRIAGE_HANDOFF' | 'CAN_REQUEST_ORDER_OWNER_REVIEW' | 'CAN_REQUEST_REFUND_OWNER_REVIEW' | 'CAN_REQUEST_ESCALATION_REVIEW' | 'CAN_ASSIGN_SUPPORT_TICKET_FOUNDATION';
...
export type SupportActionDecision = 'REJECTED' | 'ALLOWED_MASKED_VISIBILITY' | 'PENDING_OWNER_DOMAIN' | 'DUPLICATE_IDEMPOTENCY_KEY';
