...
export type CartErrorCode = 'CART_INVALID_PRODUCT' | 'CART_INVALID_VARIANT' | 'CART_INVALID_QUANTITY' | 'CART_LINE_NOT_FOUND' | 'CART_ADD_NOT_ALLOWED' | 'CART_STOCK_UNAVAILABLE' | 'CART_STOCK_UNKNOWN';
