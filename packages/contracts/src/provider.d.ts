 ...
 */
export type ProviderDomain = 'payment' | 'shipment' | 'notification' | 'payout';
/**
 ...
 */
export type ProviderMode = 'simulation' | 'sandbox' | 'parked' | 'not_configured' | 'production';
/**
 * Standardized status for an operation performed by a provider.
 */
export type ProviderOperationStatus = 'accepted' | 'succeeded' | 'failed' | 'pending' | 'unknown_result' | 'rejected';
/**
 ...
 */
export declare function createProviderBoundaryFlags(): ProviderBoundaryFlags;
/**
 ...
 */
export type ProviderCallbackVerificationStatus = 'not_required' | 'verified' | 'failed' | 'unsupported';
/**
 * The processing status of a received provider callback.
 */
export type ProviderCallbackProcessingStatus = 'received' | 'accepted' | 'duplicate' | 'rejected' | 'ignored' | 'failed';
/**
 ...
 */
export type ProviderCallbackSignatureAlgorithm = 'none' | 'hmac_sha256' | 'hmac_sha512' | 'rsa_sha256' | 'provider_managed' | 'unsupported';
/**
...
export type ProviderCallbackReplayStatus = 'first_seen' | 'replay_detected' | 'duplicate_event' | 'unknown';
 ...
 * @template TRaw - The shape of the raw data received in the callback.
 */
export interface ProviderCallbackRecord<TNormalized = unknown, TRaw = unknown> {
 ...
 */
export declare function createProviderResultEnvelope<TNormalized = unknown, TRaw = unknown>(init: Omit<ProviderResultEnvelope<TNormalized, TRaw>, 'boundary' | 'occurredAt'>): ProviderResultEnvelope<TNormalized, TRaw>;
/**
 ...
 */
export declare function createProviderCallbackEnvelope<TRaw = unknown>(init: Omit<ProviderCallbackEnvelope<TRaw>, 'boundary' | 'receivedAt'>): ProviderCallbackEnvelope<TRaw>;
/**
 ...
 */
export declare function createProviderCallbackSignatureVerificationResult(init: Omit<ProviderCallbackSignatureVerificationResult, 'boundary' | 'checkedAt' | 'signatureVerified' | 'replayDetected'> & {
