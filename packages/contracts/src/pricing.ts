...
export type CreatorVisiblePoolBasePriceSnapshot = Omit<
  PoolBasePriceSnapshot,
  'supplierBasePriceAmount'
>;
...
export interface CreatorPriceSelectionResult {
  ...
  reasonCode?:
    | 'SELECTED_PRICE_BELOW_MIN'
    | 'SELECTED_PRICE_ABOVE_MAX'
