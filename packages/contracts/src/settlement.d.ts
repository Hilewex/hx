...
export type SettlementSourceType = 'ORDER' | 'ORDER_LINE' | 'COMMERCIAL_POOL_PRODUCT' | 'CREATOR_STORE_PRODUCT' | 'CREATOR_STORE' | 'SUPPLIER' | 'DISCOUNT_ALLOCATION' | 'COUPON_SNAPSHOT' | 'LEDGER_ENTRY' | 'REFUND' | 'MANUAL_ADJUSTMENT' | 'CANCEL_RETURN' | 'FINANCE_CORRECTION' | 'RISK' | 'MANUAL_FOUNDATION';
...
export type SettlementPayableEarningStatus = 'PENDING' | 'HELD' | 'RELEASE_ELIGIBLE' | 'REVERSED' | 'PAYOUT_READY';
export type SettlementPayableEarningPartyType = 'SUPPLIER' | 'CREATOR';
...
export type SettlementPayableEarningReversalStatus = 'REVERSED' | 'IDEMPOTENT' | 'REJECTED' | 'REVIEW_REQUIRED';
