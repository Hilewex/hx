...
## Süper Yönetici / Platform Owner Kontrol Merkezi

Platformda `SUPER_ADMIN` veya `PLATFORM_OWNER` rolü bulunmalıdır.

Bu rol, platform sahibinin ve en üst düzey yöneticinin sistemi tek merkezden yönetebilmesi için tasarlanır. Süper yönetici ayrı ayrı servis ekranlarına gitmez; tüm ana operasyon modüllerine merkezi admin panel üzerinden erişir.

Ancak bu rol sınırsız doğrudan veri değiştirme yetkisi anlamına gelmez.

### Temel Kural

Süper yönetici:

- merkezi panelden işlem başlatabilir,
- tüm ana yönetim modüllerini görebilir,
- yüksek riskli işlemler için talep veya onay süreci başlatabilir,
- audit/evidence kayıtlarını inceleyebilir,
- rol ve yetki yönetimini yapabilir.

Fakat süper yönetici bile:

- doğrudan veritabanına yazamaz,
- owner servisleri bypass edemez,
- fiyat, stok, sipariş, ödeme, finans, payout veya moderasyon truth bilgisini panelden doğrudan değiştiremez,
- audit/evidence üretmeden kritik işlem yapamaz,
- maker-checker gereken işlemlerde aynı aktör olarak hem işlemi başlatıp hem onaylayamaz.

### Çalışma Modeli

Süper yönetici panelde işlem seçer.

Örnekler:

- fenomen askıya alma talebi,
- tedarikçi onay / inceleme talebi,
- ürün görünürlük inceleme talebi,
- stok düzeltme talebi,
- fiyat düzeltme talebi,
- payout hold/release talebi,
- sipariş operasyon talebi,
- moderasyon inceleme talebi,
- support escalation inceleme talebi.

Bu işlem panelde başlatılır; fakat gerçek işlem ilgili owner servise yönlendirilir.

| Panelde Başlatılan İşlem | Gerçek Sahip / Owner Servis |
|---|---|
| Fenomen askıya alma / inceleme | Creator / Fenomen Yönetim Servisi |
| Tedarikçi onay / inceleme | Supplier / Tedarikçi Yönetim Servisi |
| Ürün görünürlük inceleme | Ürün / Katalog / Havuz Owner Servisi |
| Stok düzeltme talebi | Merkezi Stok Servisi |
| Fiyat düzeltme talebi | Merkezi Fiyat Servisi |
| Moderasyon kararı | Moderasyon Servisi |
| Sipariş operasyon talebi | Order / Order-Ops Servisi |
| İade / refund inceleme | Return / Refund Owner Servisi |
| Finansal düzeltme | Finance Servisi |
| Payout hold/release | Payout / Finance Owner Servisi |
| Support escalation | Support / Operation Owner Servisi |

### Zorunlu Güvenlik Kuralları

Her süper yönetici işlemi aşağıdaki bilgileri taşımalıdır:
...
- requestedAt,
- ownerDomainHandoff,
- audit/evidence kaydı.

Kritik işlemlerde maker-checker uygulanmalıdır.

Aşağıdaki işlem tipleri tek aktörle tamamlanmamalıdır:

- payout hold/release,
- finansal düzeltme,
- yüksek riskli admin aksiyonu,
- moderasyon sonucu,
- hesap askıya alma / kapatma,
- yüksek etkili katalog görünürlük kararı,
- support escalation sonucu.

### Mimari Sınır

Süper yönetici paneli merkezi kontrol ve onay ekranıdır.

Gerçek iş kuralları ve truth mutation ilgili owner servislerde kalır.

Net kural:

```text
SUPER_ADMIN / PLATFORM_OWNER en geniş görünürlük ve işlem başlatma yetkisine sahiptir.
Ancak hiçbir koşulda owner servisleri bypass eden sınırsız direct-write yetkisine sahip değildir.