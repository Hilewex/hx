...
export type CatalogProjectionSource = 'POOL_COMMERCIAL_PRODUCT' | 'POOL_CREATOR_STORE_PRODUCT' | 'FOUNDATION_SEED';
export type CatalogVariantAvailabilityStatus = 'AVAILABLE' | 'OUT_OF_STOCK' | 'UNAVAILABLE' | 'UNKNOWN';
